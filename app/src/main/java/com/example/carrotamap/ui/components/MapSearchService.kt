        ...
        val providerResults = when (preferredProvider) {
            SearchProvider.GAODE -> {
                ...
                if (proxLat != null && proxLon != null) {
                    val gcj = com.example.carrotamap.navigation.CoordinateConverter.wgs84ToGcj02(proxLat, proxLon)
            ...
            SearchProvider.TENCENT -> {
                serviceName = "腾讯地图"
                if (proxLat != null && proxLon != null) {
                    val gcjCoords = com.example.carrotamap.navigation.CoordinateConverter.wgs84ToGcj02(proxLat, proxLon)
