...
class OsmNavigationManager(
    ...
    private val networkClient: com.example.navipilot.CarrotManNetworkClient?,
    private val carrotManFields: androidx.compose.runtime.MutableState<com.example.navipilot.CarrotManFields>?,
    ...
    fun getCurrentLaneInfo(): List<com.example.navipilot.navigation.LaneInfo>? = null
    fun cleanup() {}
}
